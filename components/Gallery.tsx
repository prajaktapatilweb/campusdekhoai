      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p
            ...
            "
          >
            Glimpses from our previous events showcasing the impact
            we&apos;ve made on thousands of students
          </p>
        </motion.div>
        ...
        >
              ...
              <SwiperSlide key={index}>
                ...
                >
                  ...
                  >
                    <h3
                      className="
                        mb-1 text-xl font-semibold text-white
                      "
                    >
                      {image.title}
                    </h3>
          ...
          <div
            className="
              mt-8 hidden items-center justify-center gap-4
              md:flex
            "
          >
            <button
